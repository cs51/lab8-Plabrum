...
let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
  let new_listener = {id = new_id (); action = listener} in 
    evt := new_listener :: !evt;
    new_listener.id ;; 
...
......................................................................*)
  ...
  let rec remove_listener (evt : 'a event) (i : id) : unit =
    evt := List.filter (fun elem -> not(elem.id = i)) !evt ;;
...
......................................................................*)
  ...
  let fire_event (evt : 'a event) (arg : 'a) : unit =
    List.iter (fun elem -> elem.action arg) !evt ;; 
...
let _ = fun _ -> (List.fold_left (fun i n ->  WEvent.remove_listener !n i; i - 1)
                       (List.hd !newswire).id !newswire); ()

(*......................................................................
Exercise 8: Create a new event called publish to signal that all
stories should be published. The event should be a unit let _ = WEvent.event.
......................................................................*)
